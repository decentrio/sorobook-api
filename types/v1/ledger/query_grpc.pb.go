...
const (
	LedgerQuery_Ping_FullMethodName = "/v1.ledger.LedgerQuery/Ping"
)
...
func (c *ledgerQueryClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	out := new(PingResponse)
	err := c.cc.Invoke(ctx, LedgerQuery_Ping_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedLedgerQueryServer must be embedded to have forward compatible implementations.
type UnimplementedLedgerQueryServer struct {
}

func (UnimplementedLedgerQueryServer) Ping(context.Context, *PingRequest) (*PingResponse, error) {
...
func _LedgerQuery_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LedgerQueryServer).Ping(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LedgerQuery_Ping_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LedgerQueryServer).Ping(ctx, req.(*PingRequest))
	}
...
var LedgerQuery_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "v1.ledger.LedgerQuery",
	HandlerType: (*LedgerQueryServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Ping",
			Handler:    _LedgerQuery_Ping_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "v1/ledger/query.proto",
}
