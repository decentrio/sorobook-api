...
const (
	ContractQuery_Ping_FullMethodName = "/v1.contract.ContractQuery/Ping"
)
...
func (c *contractQueryClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	out := new(PingResponse)
	err := c.cc.Invoke(ctx, ContractQuery_Ping_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedContractQueryServer) Ping(context.Context, *PingRequest) (*PingResponse, error) {
...
func _ContractQuery_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ContractQueryServer).Ping(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ContractQuery_Ping_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ContractQueryServer).Ping(ctx, req.(*PingRequest))
	}
...
var ContractQuery_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "v1.contract.ContractQuery",
	HandlerType: (*ContractQueryServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Ping",
			Handler:    _ContractQuery_Ping_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "v1/contract/query.proto",
}
